...
public class GoogleSheetsHelper {
    private static Log log = LogFactory.getLog(GoogleSheetsHelper.class);
    ...
    private static final java.io.File DATA_STORE_DIR = new java.io.File(
            System.getProperty("user.dir"), ".credentials/sheets.googleapis.com-java-quickstart");
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                new FileInputStream(new File(System.getProperty("user.dir") + "/client_secret.json"));
...
//        appendOrder("project", "order", "cardHolder", "cardInfo");
//    }
