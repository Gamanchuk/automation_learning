...
Feature: Guest - Shipping & Billing page
  ...
  Scenario: Test field 'City'
    ...
    And user types "" into the "City" field of "Shipping Address" form
    And presses the "Continue" button
    And chooses "Use Entered Address"
    Then user should stay at "Billing & Shipping" tab
    And sees "FORM ERRORS" error message with text "City is required"

    And user types "SanFrancisco" into the "City" field of "Shipping Address" form
    And presses the "Continue" button
    And chooses "Use Entered Address"
    ...
    And user types "123456" into the "City" field of "Shipping Address" form
    And presses the "Continue" button
    And chooses "Use Entered Address"
    Then user checks city info with value "123456" on "Delivery Method" tab
    And user navigates to "Billing & Shipping" breadcrumb

    And user types "!@$%^&*():_+" into the "City" field of "Shipping Address" form
    And presses the "Continue" button
    And chooses "Use Entered Address"
