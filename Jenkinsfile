  ...
  branches[device] = {
	stage(device) {
	  build job: "device_run", parameters: [
	  	...
	  	[$class: 'com.cwctravel.hudson.plugins.extended_choice_parameter.ExtendedChoiceParameterValue', name: 'SUITES', value: "${SUITES}"],
	  	[$class: 'BooleanParameterValue', name: 'PROJECT_TRACKING', value: params.PROJECT_TRACKING],
